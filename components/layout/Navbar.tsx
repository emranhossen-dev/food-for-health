  ...
  return (
    <nav className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="hidden sm:block text-xl font-bold text-primary">Food for Health</span>
            </Link>
          </div>
        ...
        {/* Mobile Search Bar - Only show when search icon is clicked */}
        {isMobileSearchOpen && (
          <div className="md:hidden pb-3 border-t border-gray-200">
            <div className="relative pt-3">
              <input
                ...
                autoFocus
              />
              <Search className="absolute left-3 top-5.5 h-5 w-5 text-gray-400" />
            </div>
          </div>
        )}
